        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input name="sale_price" type="number" class="form-control @error('sale_price') is-invalid @enderror"
                        value="{{ old('sale_price', $course->sale_price) }}" placeholder="Nhập giá khuyến mãi...">
                    @error('sale_price')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input name="code" type="text" class="form-control @error('code') is-invalid @enderror"
                        value="{{ old('code', $course->code) }}" placeholder="Nhập mã...">
                    @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="supports" class="form-control @error('supports') is-invalid @enderror" rows="3"
                        placeholder="Nhập hỗ trợ...">{{ old('supports', $course->supports) }}</textarea>
                    @error('supports')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="row {{ $errors->has('thumbnail') ? 'align-items-center' : 'align-items-end' }}">
                        <div class="col-7">
                            ...
                            <input name="thumbnail" id="thumbnail" type="text"
                                ...
                                value="{{ old('thumbnail', $course->thumbnail) }}" placeholder="Link ảnh..."
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="detail" id="detail" class="form-control ckeditor @error('detail') is-invalid @enderror"
                        rows="4">{{ old('detail', $course->detail) }}</textarea>
                    @error('detail')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
